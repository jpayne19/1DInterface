...
function setup() {
  ...
  playerOne = new Player(color(220,0,0), parseInt(random(0,displaySize)), displaySize);   // Initializing players
  playerTwo = new Player(color(0,0,215), parseInt(random(0,displaySize)), displaySize);
